...
function GenerateQuadsPowerups(atlas)
    ...
    local counter = 1
    for i = 0,9 do
      quads[counter] = love.graphics.newQuad(x + 16 * i, y, 16, 16, atlas:getDimensions())
      counter = counter + 1
    end
...
function GenerateQuadLockBrick(atlas)
  quad = {}
  quad[1] = love.graphics.newQuad(160,48,32,16,atlas:getDimensions())
  return quad
end
